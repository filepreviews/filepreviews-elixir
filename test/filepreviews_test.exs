defmodule FilePreviewsTest do
  ...
  test "generate" do
    use_cassette "generate", custom: true do
      ...
      assert status == :ok
      assert response["url"] == "https://api.filepreviews.io/v2/previews/42764e04-9094-467c-96b3-49d31ff4423d/"
  ...
  test "retrieve" do
    use_cassette "retrieve", custom: true do
      ...
      assert status == :ok
      assert response["url"] == "https://api.filepreviews.io/v2/previews/9ed9ff9e-a734-4901-9f75-4c229cd83498/"
